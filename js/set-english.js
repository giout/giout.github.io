...
export const setEnglish = () => {
    ...
    aboutContent.innerText = 'I am a computer engineer dedicated to software development. My goals are to grow professionally and contribute value to the business environment. I plan to achieve these goals by developing scalable, understandable, and well-documented applications, through adaptability, discipline, teamwork, and continuous learning.'
